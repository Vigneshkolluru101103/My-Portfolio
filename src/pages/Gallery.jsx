...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Cricket enthusiast — teamwork, discipline, and focus",
      photos: ["/gallery/cricket.jpg", "/gallery/me1.jpg"],
    },
    {
      id: 2,
      caption:
        "Learning, building, and growing as a developer",
      photos: ["/gallery/me.jpg", "/gallery/m2.jpg"],
    },
  ],
  projects: [
    {
  ...
  achievements: [
    {
      id: 1,
      caption: "Internship Completion Certificate",
      photos: ["/gallery/intern.png"],
    },
    {
      id: 2,
      caption: "Foundations: Data, Data, Everywhere — Google (Coursera)",
      photos: ["/gallery/google.png"],
    },
    {
      id: 3,
      caption: "Software Engineer Intern — HackerRank Role Certification",
      photos: ["/gallery/hackerrank.png"],
    },
    {
      id: 4,
      caption: "Full stack Developer completion certificate",
      photos: ["/gallery/fs.png"],
    },
  ],
};
